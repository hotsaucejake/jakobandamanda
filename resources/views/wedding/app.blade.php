...
<head>
    ...
    <!-- Page Title -->
    <title> Jakob and Amanda </title>

    <!-- Favicon and Touch Icons -->
    <link href="/wedding/images/favicon/favicon.png" rel="shortcut icon" type="image/png">
    <link href="/wedding/images/favicon/apple-touch-icon.png" rel="apple-touch-icon">
    <link href="/wedding/images/favicon/apple-touch-icon-72x72.png" rel="apple-touch-icon" sizes="72x72">
    <link href="/wedding/images/favicon/apple-touch-icon-114x114.png" rel="apple-touch-icon" sizes="114x114">
    <link href="/wedding/images/favicon/apple-touch-icon-144x144.png" rel="apple-touch-icon" sizes="144x144">
...
<body id="home">
    ...
    <div class="page-wrapper">
        ...
        <section class="hero">
            ...
            <div class="wedding-announcement">
                <div class="couple-name-merried-text">
                    <h2 class="wow slideInUp" data-wow-duration="1s">Jakob &amp; Amanda</h2>
                    <div class="married-text wow fadeIn" data-wow-delay="1s">
                        ...
                        <span class=" wow fadeInUp" data-wow-delay="1.15s">p</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.20s">l</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.25s">e</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.30s">y</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.35s">E</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.40s">v</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.45s">e</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.50s">r</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.55s">C</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.60s">r</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.65s">o</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.70s">w</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.75s">d</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.80s">e</span>
                        <span class=" wow fadeInUp" data-wow-delay="1.85s">r</span>
                        </h4>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-md-4">
                        <h2><span>Waiting for the...</span> Next chapter</h2>
                    </div>
                        ...
                        <div class="inportant-people-content">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active grid-wrapper" id="groomsmen">
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/groomsmen/img-1.jpg" class="popup-image">
                                                <img src="/wedding/images/groomsmen/img-1.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Jhon Michel</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/groomsmen/img-2.jpg" class="popup-image">
                                                <img src="/wedding/images/groomsmen/img-2.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Chasmoos jhon</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/groomsmen/img-3.jpg" class="popup-image">
                                                <img src="/wedding/images/groomsmen/img-3.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Kaiste pate</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/groomsmen/img-4.jpg" class="popup-image">
                                                <img src="/wedding/images/groomsmen/img-4.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Hatu Michel</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/groomsmen/img-5.jpg" class="popup-image">
                                                <img src="/wedding/images/groomsmen/img-5.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Michel doin</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/groomsmen/img-6.jpg" class="popup-image">
                                                <img src="/wedding/images/groomsmen/img-6.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Topper jone</h3>
                                ...
                                <div class="tab-pane fade grid-wrapper" id="bridesmaid">
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/bridesmaid/img-1.jpg" class="popup-image">
                                                <img src="/wedding/images/bridesmaid/img-1.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Rachel Li</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/bridesmaid/img-2.jpg" class="popup-image">
                                                <img src="/wedding/images/bridesmaid/img-2.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Male Vign</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/bridesmaid/img-3.jpg" class="popup-image">
                                                <img src="/wedding/images/bridesmaid/img-3.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Jonny Mich</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/bridesmaid/img-4.jpg" class="popup-image">
                                                <img src="/wedding/images/bridesmaid/img-4.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Brodd Wid</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/bridesmaid/img-5.jpg" class="popup-image">
                                                <img src="/wedding/images/bridesmaid/img-5.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Nokshal bedi</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="/wedding/images/bridesmaid/img-6.jpg" class="popup-image">
                                                <img src="/wedding/images/bridesmaid/img-6.jpg" alt class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Holly Fie</h3>
        ...
        <!-- start rsvp-section -->
        <section class="rsvp-section section-padding parallax" data-bg-image="/wedding/images/rsvp-bg.jpg" data-speed="7" id="rsvp">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                ...
                <div class="row content">
                    <div class="col col-lg-10 col-lg-offset-1">
                        ...
                        <div class="gif-registration-slider">
                            <div class="register">
                                <img src="/wedding/images/gift/img-1.jpg" alt class="img img-responsive">
                            </div>
                            <div class="register">
                                <img src="/wedding/images/gift/img-2.jpg" alt class="img img-responsive">
                            </div>
                            <div class="register">
                                <img src="/wedding/images/gift/img-3.jpg" alt class="img img-responsive">
                            </div>
                            <div class="register">
                                <img src="/wedding/images/gift/img-1.jpg" alt class="img img-responsive">
                            </div>
