<section class="gift-registration-section section-padding" id="registry">
    <div class="container">
        <div class="row">
        ...
        <div class="row content">
            <div class="col col-lg-12">
                <p>Please note that your love and support is all we ask for on our special day. However, if you do wish to celebrate with a gift, we are registered at:</p>
            </div>
        </div> <!-- end row -->

        <div class="row content text-center" style="margin-top:50px;">
            <div class="col col-lg-12">
